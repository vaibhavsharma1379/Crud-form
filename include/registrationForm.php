...
<form id="<?php if (isset($ID)) {
            echo 'EmpForm';
          } ?>" method="post" class="border rounded shadow mb-5" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
  <?php
  if (isset($ID)) { ?>
  ...
  <div class="container-fluid container-border m-1">
    <div class="row">
      <div class="col-sm-12 col-lg-6">
        ...
        <input type="text" class="form-control" id="name" name="name" value="<?php if (isset($Employee_name)) {
                                                                                echo $Employee_name;
                                                                              } ?>">
      ...
      <div class="col-sm-12 col-lg-6">
        ...
        <input type="text" id="fathername" class="form-control" name="fathername" value="<?php if (isset($Employee_name)) {
                                                                                            echo $Employee_name;
                                                                                          } ?>"><br><br>
      </div>
    </div>
    <div class="row">
      <div class="col-6">
        ...
        <input type="text" id="mobile" class="form-control" name="mobile" value="<?php if (isset($Mobile_number)) {
                                                                                    echo $Mobile_number;
                                                                                  } ?>"><br><br>
      </div>
      <div class="col-6">
        <label for="age">Age:</label><span class="error">*<?php echo $ageErr ?></span><br>
        <input type="number" pattern="[0-9]+" id="age" name="age" class="form-control" style="width: 50px;" value="<?php if (isset($Age)) {
                                                                                                                      echo $Age;
                                                                                                                    } ?>"><br><br>
      </div>
    </div>
    <div class="row">
      <div class="col-6">
        ...
        <div class="d-flex justify-content-start">
          <div>
            <input class="form-check-input" type="radio" id="male" name="gender" value="M" <?php if (isset($Gender) && $Gender == "M") {
                                                                                              echo "checked";
                                                                                            } elseif (!isset($Gender)) {
                                                                                              echo "checked";
                                                                                            } ?>>
          ...
          <div>
            <input class="form-check-input" type="radio" id="female" name="gender" value="F" <?php if (isset($Gender) && $Gender == "F") {
                                                                                                echo "checked";
                                                                                              } ?>>
      ...
      <div class="col-6">
        ...
        <div>
          ...
          <input class="form-check-input" name="intrest[]" type="checkbox" value="python" <?php if (isset($Skills) && str_contains($Skills, "python")) {
                                                                                            echo "checked";
                                                                                          } ?> id="python" />
          <label class="form-check-label" for="python">Python</label>
          <input class="form-check-input" name="intrest[]" type="checkbox" value="java" <?php if (isset($Skills) && str_contains($Skills, "java")) {
                                                                                          echo "checked";
                                                                                        } ?> id="java" />
          <label class="form-check-label" for="java">Java</label>
          <input class="form-check-input" name="intrest[]" type="checkbox" value="php" <?php if (isset($Skills) && str_contains($Skills, "php")) {
                                                                                          echo "checked";
                                                                                        } ?> id="php" />
          <label class="form-check-label" for="php">PHP</label>
          <input class="form-check-input" name="intrest[]" type="checkbox" value="c++" <?php if (isset($Skills) && str_contains($Skills, "c++")) {
                                                                                          echo "checked";
                                                                                        } ?> id="c++" />
          <label class="form-check-label" for="c++">C++</label>
          <input class="form-check-input" name="intrest[]" type="checkbox" value="dart" <?php if (isset($Skills) && str_contains($Skills, "dart")) {
                                                                                          echo "checked";
                                                                                        } ?> id="dart" />
          <label class="form-check-label" for="dart">Dart</label>
          <input class="form-check-input" name="intrest[]" type="checkbox" value="javascript" <?php if (isset($Skills) && str_contains($Skills, "javascript")) {
                                                                                                echo "checked";
                                                                                              } ?> id="javascript" />
    ...
    <div class="row">
      <div class="col-sm-12 col-lg-6">
        ...
        <input class="form-control" type="date" id="dob" , name="dob" value="<?php if (isset($DOB)) {
                                                                                echo $DOB;
                                                                              } ?>" />
      </div>
      ...
      <div class="col-sm-12 col-lg-6">
        ...
        <input class="form-control" type="date" id="doj" , name="doj" value="<?php if (isset($DOJ)) {
                                                                                echo $DOJ;
                                                                              } ?>" />
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12 col-lg-6  mt-3 mb-3">
        ...
        <select id="State" class="form-select" name="state">
          <option value="<?php if (isset($State)) {
                            echo $State;
                          } else {
                            echo "";
                          } ?>"><?php if (isset($State)) {
    ...
    <div class="mb-3 mt-3">
      ...
      <select class="form-select" id="designation" name="designation" value="<?php if (isset($Designation)) {
                                                                                echo $Designation;
                                                                              } ?>">
        <option value="<?php if (isset($Designation)) {
                          echo $Designation;
                        } else {
                          echo "";
    ...
    <textarea class="form-control" id="about" name="about" rows="4" cols="50"><?php if (isset($About_employee)) {
                                                                                echo $About_employee;
                                                                              } ?></textarea><br><br>
